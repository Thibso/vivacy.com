...
export default function Footer() {
  ...
  return (
    <footer className="lg:sticky lg:bottom-0 z-[1] pt-8 lg:pt-20">
      <div className="px-5 lg:px-20 xl:px-24 lg:grid lg:grid-cols-3">
        ...
        <div>
          <Image
            src={map}
            alt={t("vivacy.mapAlt")}
            className="max-lg:py-8 max-sm:w-[100%] max-lg:w-[70%] max-lg:mx-auto"
          />
        </div>
      </div>
      ...
      <div className="bg-blue px-5 lg:px-20 xl:px-24 py-2 text-white flex justify-start max-lg:flex-wrap w-full gap-2 lg:gap-x-8 text-[10px]">
