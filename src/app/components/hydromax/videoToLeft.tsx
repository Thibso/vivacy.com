...
export default function VideoToLeftHydromax() {
  ...
  return (
    <div ref={ref} className="lg:min-h-[100vh] relative">
      <div className="max-lg:flex max-lg:flex-col-reverse max-lg:gap-y-8 lg:grid lg:grid-cols-3 lg:items-center lg:gap-x-20 lg:sticky lg:top-[25%]">
        <motion.div
          style={{
            scale: scaleProgress,
            x: xProgressVideo,
          }}
          className="col-span-2 relative z-[2] origin-top"
        >
          <video
            ref={videoRef}
          ...
          >
            <source
              src="/videos/Animatique-Hydromax-Fusion.mp4"
              type="video/mp4"
            />
          </video>
        </motion.div>
        ...
        <motion.div
          ...
          className="col-span-1 space-y-8 lg:space-y-20"
        >
          <FromTopTitles
